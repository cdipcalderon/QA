...
//cdisolar.hopto.org:8889/qa/script.php?tp0=1&v1=1&c1=1&v2=1&c2=1&v3=1&c3=1&vr=1&cr=1&vb=1&cb=1&Irms=1
...
isset($_GET['vr']) or isset($_GET['cr']) or isset($_GET['vb']) or isset($_GET['cb']) or isset($_GET['Irms']) 
	...
	echo "user: $username \r\n  <br>dbname: $dbname \r\n";
		...
		rrd_update ("/rrdtool/bdrrd.rrd average --start 1451617200 --end 1502317345");
